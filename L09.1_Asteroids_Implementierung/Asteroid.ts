    ...
    export class Asteroid {
        ...
        constructor(_size: number, _position?: Vector) {
            ...
            if (_position)
                ...
                this.position = new Vector(0, 0); //neuer Vektor wird kreiert
        ...
        move(_timeslice: number): void {
            ...
            let offset: Vector = new Vector(this.velocity.x, this.velocity.y); //Weg, der sich der Asteroid bewegen soll -> Kopie des Velocity Vektors
        ...
        draw(): void {
            ...
            crc2.save(); //alte Transformation soll abgespeichert werden
            crc2.translate(this.position.x, this.position.y);
            crc2.scale(this.size, this.size); //Skalierung in Horizontale und Vertikale
            crc2.translate(-50, -50); //Verschiebung um 50 nach links und rechts, damit der Asteroid in der Ecke liegt
            crc2.stroke(asteroidPaths[this.type]); //Pfad, aus aseroid Paths -> liegen in dem Array
            crc2.restore(); 
        }
