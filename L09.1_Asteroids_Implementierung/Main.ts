namespace L09_Asteroids {
    ...
    let asteroids: Asteroid[] = []; //neuer Asteroid
    ...
    function handleLoad(_event: Event): void {
        ...
        crc2.fillStyle = "black"; //schwarzer HIntergrund
        crc2.strokeStyle = "white"; //weiße Linien

        createPaths(); //in Paths.ts
        console.log("Asteroids paths: ", asteroidPaths); //Pfade werden ausgegeben
    ...
    function createAsteroids(_nAsteroids: number): void {
        ...
        for (let i: number = 0; i < _nAsteroids; i++) {
            let asteroid: Asteroid = new Asteroid(1.0); //kreiere einen neuen Asteroid
